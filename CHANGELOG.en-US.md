...
- Import shared utilities from @m-eleplus-crud/utils (#18048 by @makedopamine)
...
- m-eleplus-crud Support last 2 versions of browsers (#15313 by @kooriookami)
...
- Cannot find type definition file for `m-eleplus-crud/global` (#13698 by @mioxs)
...
- m-eleplus-crud exposing ElSubMenu component (#11100 by @tolking)
...
- m-eleplus-crud dts entry (#8842 by @holazz)
...
- m-eleplus-crud fix type error (#8982 by @holazz)
...
[v2.2.0 release note](https://github.com/m-eleplus-crud/m-eleplus-crud/discussions/7578)

#### Breaking changes

##### Button

- `type="text"` has been removed from `button`, now you can do this, for more detail see [Documentation](https://m-eleplus-crud.org/en-US/component/button.html#text-button)
...
- Please refer to: [1.3.0-beta.1 Breaking change](https://github.com/m-eleplus-crud/m-eleplus-crud/discussions/5037)
...
- Docs replace @m-eleplus-crud/icons with @element-plus/icons-vue (#4704 by @pdsuwwz)
...
- Please refer to: [1.2.0-beta.1 Breaking change](https://github.com/m-eleplus-crud/m-eleplus-crud/discussions/4060)
...
- Dev play add @m-eleplus-crud/icons (#4034 by @xiaoxian521)
...
- Please refer to: [Breaking changes made in 1.1.0-beta.1](https://github.com/m-eleplus-crud/m-eleplus-crud/discussions/3020)
